...
<aside id="logo-sidebar"className="bg-[#111827] fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-autobg-gray-800">
      <a href="/pages/dashboard/home" className="flex items-center pl-2.5 mb-5">
         <img src="/images/logos/logo1.png" className="mr-3 w-44" alt="Flowbite Logo" />
      </a>
